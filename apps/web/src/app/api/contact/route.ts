  ...
  <div style="background: white; padding: 40px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
    <div style="margin-bottom: 30px;">
      ...
      <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; border-left: 4px solid #667eea;">
        <p style="margin: 0 0 12px 0;"><strong>Name:</strong> ${contactData.name}</p>
        <p style="margin: 0 0 12px 0;"><strong>Email:</strong> <a href="mailto:${contactData.email}" style="color: #667eea; text-decoration: none;">${contactData.email}</a></p>
        ${contactData.company ? `<p style="margin: 0 0 12px 0;"><strong>Company:</strong> ${contactData.company}</p>` : ''}
        ${contactData.phone ? `<p style="margin: 0 0 12px 0;"><strong>Phone:</strong> ${contactData.phone}</p>` : ''}
        <p style="margin: 0;"><strong>Inquiry Type:</strong> <span style="background: #e3f2fd; padding: 4px 8px; border-radius: 4px; font-size: 14px;">${contactData.inquiryType}</span></p>
      </div>
    </div>
    
    <div style="margin-bottom: 30px;">
      <h3 style="color: #333; margin: 0 0 15px 0; font-size: 18px;">Subject</h3>
      <p style="background: #f1f3f4; padding: 15px; border-radius: 6px; margin: 0; font-weight: 500; color: #444;">${contactData.subject}</p>
    </div>
    ...
    <div style="margin-bottom: 30px;">
      ...
      <div style="background: #fafafa; padding: 20px; border-radius: 6px; border: 1px solid #e0e0e0;">
        <p style="margin: 0; line-height: 1.6; color: #555; white-space: pre-wrap;">${contactData.message}</p>
      </div>
    </div>
