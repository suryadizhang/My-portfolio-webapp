/**
 * ChatWidget - A Next.js 15 compatible client component
 * 
 * This component uses vanilla JavaScript DOM manipulation to create a chat button
 * that bypasses React hydration issues in Next.js 15.5.3
 */
'use client'
...
export default function ChatWidget() {
  useEffect(() => {
    ...
    button.addEventListener('click', () => {
      // Placeholder action - replace with your chat system
  ...
  // The actual UI is created via direct DOM manipulation
  return null
}